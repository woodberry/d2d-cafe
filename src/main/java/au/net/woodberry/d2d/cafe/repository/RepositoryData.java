...
public class RepositoryData {
    ...
    static {
        ...
        MENU_ITEM_EXTRAS.put("Coco powder", new MenuItemExtra("Coco powder", BigDecimal.valueOf(0.10)));

        MENU_ITEM_SIZES.put("Standard", new MenuItemSize("Standard", BigDecimal.valueOf(1.00)));
